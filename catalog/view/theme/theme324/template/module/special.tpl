			...
			<li class="<?php echo $a. $last_line ;?> span<?php echo $spanLine ;?>">
						...
						<div class="quick-view-<?php echo $i;?> preview">
							<div class="wrapper marg row-fluid">
								...
								<div class="right span8">
									...
									<div class="clear"></div>
									<div class="rating">
										<img height="18" src="catalog/view/theme/theme324/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
									</div>
								</div>
							</div>
				...
				<div class="inner">
					<div class="f-left">
						...
						<div class="name"><a class="maxheight-spec" href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></div>
