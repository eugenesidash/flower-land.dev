<div id="cart" >
  ...
  <div class="content-scroll">
		...
		<tr>
		  ...
		  <td class="name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
			<div>
			  ...
			  <span class="total"><?php echo $product['total']; ?></span>	<div class="remove"><span onclick="(getURLVar('route') == 'checkout/cart' || getURLVar('route') == 'checkout/checkout') ? location = 'index.php?route=checkout/cart&remove=<?php echo $product['key']; ?>' : $('#cart').load('index.php?route=module/cart&remove=<?php echo $product['key']; ?>' + ' #cart > *');"  ><i class="icon-remove-sign"></i></span></div>		  
			  </td>	
	...
	<div class="checkout">
			<a class="button" href="<?php echo $cart; ?>"><i class="icon-eye-open"></i><span><?php echo $text_cart; ?></span></a> 
			<a class="button" href="<?php echo $checkout; ?>"><i class="icon-check"></i><span><?php echo $text_checkout; ?></span></a>
	</div>
	<?php } else { ?>
